...
- [ ] QA sign-off from Priya`),
  ...
  roadmap: exec("s-roadmap", "roadmap", "## Roadmap", {
    ...
    tasks: [
      { name: "Email notifications (MVP)", lane: "Sprint 1", startWeek: 1, endWeek: 3 },
      { name: "Recipient management", lane: "Sprint 1", startWeek: 3, endWeek: 4 },
      { name: "Webhook delivery", lane: "Sprint 2", startWeek: 5, endWeek: 6 },
      { name: "Notification history", lane: "Sprint 2", startWeek: 7, endWeek: 8 },
    ],
  }),
